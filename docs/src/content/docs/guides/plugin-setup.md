...
tauri-pilot ping
# Connected. Plugin and CLI both 0.8.0.
```
...
```bash
tauri-pilot ping
# Connected. Plugin 0.7.3, CLI 0.8.0.
# Plugin 0.7.3 and CLI 0.8.0 differ. Rebuild your app against tauri-plugin-pilot 0.8.0 ...
```
